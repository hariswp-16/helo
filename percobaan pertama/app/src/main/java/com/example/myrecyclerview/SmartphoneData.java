...
public class SmartphoneData {
    ...
    private static int[] SmartphoneImages = {
            R.drawable.galaxysfuasatuultra,
            R.drawable.galaxysduasatuplus,
            R.drawable.galaxysduasatubiasa,
            R.drawable.noteduapuluhultra,
            R.drawable.sduapuluhultra,
            R.drawable.galaxynoteduapuluh,
            R.drawable.galaxyzfolddua,
            R.drawable.galaxysduapuluhplus,
            R.drawable.galaxysduapuluh,
            R.drawable.galaxysduapuluhfe
    };
